...
L.VERSIONCHECK_HEADER				= "Dungeon Boss Mods - Versões"
...
L.YOUR_VERSION_OUTDATED				= "Sua versão do Dungeon Boss Mods está desatualizada. Por favor, acesse www.deadlybossmods.com para baixar a versão mais recente."
L.VOICE_PACK_OUTDATED				= "O pacote de vozes do seu " .. L.DBM .. " pode estar sem alguns dos sons suportados por esta versão do DBM. Filtro de aviso especial sonoro foi desativado. Por favor baixe a versão mais recente do pacote de vozes ou contate o autor para um pacote que contenha os sons aqui referidos."
...
L.UPDATEREMINDER_HEADER				= "Sua versão do Dungeon Boss Mods está desatualizada.\n A versão %s (%s) está disponível para baixar no site da curse, WoWI ou aqui:"
...
L.OUTDATEDPROFILES						= "AVISO: DBM-Profiles não é compatível com esta versão de " .. L.DBM .. ". Deve ser removida antes de " .. L.DBM .. " continuar para evitar conflitos."
