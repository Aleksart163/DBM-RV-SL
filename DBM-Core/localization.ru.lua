...
L.AUTO_ANNOUNCE_TEXTS.cast 			= "Применение %s: %.1f сек"
...
L.AUTO_SPEC_WARN_TEXTS.dispel 			= "%s на |3-5(>%%s<) - рассей"
L.AUTO_SPEC_WARN_TEXTS.interrupt		= "%s - прерви каст!"
L.AUTO_SPEC_WARN_TEXTS.interruptcount	= "%s - прерви каст (%%d)"
...
L.AUTO_SPEC_WARN_TEXTS.defensive		= "%s - защитись"
L.AUTO_SPEC_WARN_TEXTS.taunt			= "%s на >%%s< - затаунти"
L.AUTO_SPEC_WARN_TEXTS.close 			= "%s на |3-5(>%%s<) около Вас"
L.AUTO_SPEC_WARN_TEXTS.move 			= "%s - отбеги"
L.AUTO_SPEC_WARN_TEXTS.keepmove			= "%s - продолжай двигаться"
L.AUTO_SPEC_WARN_TEXTS.stopmove			= "%s - остановись"
L.AUTO_SPEC_WARN_TEXTS.dodge			= "%s - избегай"
L.AUTO_SPEC_WARN_TEXTS.dodgecount		= "%s (%%s) - избегай"
L.AUTO_SPEC_WARN_TEXTS.dodgeloc			= "%s - избегай от %%s"
L.AUTO_SPEC_WARN_TEXTS.moveaway			= "%s - отбеги от других"
L.AUTO_SPEC_WARN_TEXTS.moveawaycount	= "%s (%%s) - отбеги от других"
L.AUTO_SPEC_WARN_TEXTS.moveto			= "%s - беги к >%%s<"
L.AUTO_SPEC_WARN_TEXTS.soak				= "%s - перекрой"
L.AUTO_SPEC_WARN_TEXTS.soakcount		= "%s - перекрой %%s"
L.AUTO_SPEC_WARN_TEXTS.jump				= "%s - подпрыгни"
L.AUTO_SPEC_WARN_TEXTS.run 				= "%s - убегай"
L.AUTO_SPEC_WARN_TEXTS.cast 			= "%s - прерви свой каст!"
L.AUTO_SPEC_WARN_TEXTS.lookaway			= "%s на %%s - отвернись"
L.AUTO_SPEC_WARN_TEXTS.lookaway2		= "%s - отвернись"
L.AUTO_SPEC_WARN_TEXTS.reflect 			= "%s на |3-5(>%%s<) - прекрати атаку"
L.AUTO_SPEC_WARN_TEXTS.count 			= "%s! (%%s)"
L.AUTO_SPEC_WARN_TEXTS.stack 			= "На Вас %%d стаков от %s"
L.AUTO_SPEC_WARN_TEXTS.switch 			= "%s - переключись"
L.AUTO_SPEC_WARN_TEXTS.switchcount 		= "%s - переключись (%%s)"
L.AUTO_SPEC_WARN_TEXTS.gtfo				= "Под тобой %%s - выбеги"
L.AUTO_SPEC_WARN_TEXTS.adds				= "Прибыли адды - смени цель"
...
L.AUTO_SPEC_WARN_OPTIONS.lookaway2		= "Спецпредупреждение \"отвернитесь\" для $spell:%s"
...
L.AUTO_SPEC_WARN_OPTIONS.usespell		= "Спецпредупреждение для использования особо важной способности"
